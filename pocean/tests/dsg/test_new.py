...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            jn(dn(__file__), "profile", "resources", "om-single.nc"),
        ),
        (
            OrthogonalMultidimensionalProfile,
            jn(dn(__file__), "profile", "resources", "om-multiple.nc"),
        ),
        (
            OrthogonalMultidimensionalProfile,
            jn(dn(__file__), "profile", "resources", "om-1dy11.nc"),
        ),
        (
            IncompleteMultidimensionalProfile,
            jn(dn(__file__), "profile", "resources", "im-multiple.nc"),
        ),
        (
            IncompleteMultidimensionalTrajectory,
            jn(dn(__file__), "trajectory", "resources", "im-single.nc"),
        ),
        (
            IncompleteMultidimensionalTrajectory,
            jn(dn(__file__), "trajectory", "resources", "im-multiple.nc"),
        ),
        (
            IncompleteMultidimensionalTrajectory,
            jn(dn(__file__), "trajectory", "resources", "im-multiple-nonstring.nc"),
        ),
        (
            IncompleteMultidimensionalTrajectory,
            jn(dn(__file__), "trajectory", "resources", "wave-glider-int-attrs.nc"),
        ),
        ...
        (
            ...
            jn(dn(__file__), "trajectoryProfile", "resources", "cr-single.nc"),
        ),
        (
            ContiguousRaggedTrajectoryProfile,
            jn(dn(__file__), "trajectoryProfile", "resources", "cr-multiple.nc"),
        ),
        (
            ContiguousRaggedTrajectoryProfile,
            jn(dn(__file__), "trajectoryProfile", "resources", "cr-missing-time.nc"),
        ),
        (
            IncompleteMultidimensionalTimeseries,
            jn(dn(__file__), "timeseries", "resources", "im-multiple.nc"),
        ),
        (
            OrthogonalMultidimensionalTimeseries,
            jn(dn(__file__), "timeseries", "resources", "om-single.nc"),
        ),
        (
            OrthogonalMultidimensionalTimeseries,
            jn(dn(__file__), "timeseries", "resources", "om-multiple.nc"),
        ),
        ...
        (
            ...
            jn(dn(__file__), "timeseriesProfile", "resources", "om-multiple.nc"),
        ),
        (
            IncompleteMultidimensionalTimeseriesProfile,
            jn(dn(__file__), "timeseriesProfile", "resources", "im-single.nc"),
        ),
        (
            IncompleteMultidimensionalTimeseriesProfile,
            jn(dn(__file__), "timeseriesProfile", "resources", "im-multiple.nc"),
        ),
        (
            RaggedTimeseriesProfile,
            jn(dn(__file__), "timeseriesProfile", "resources", "r-single.nc"),
        ),
        (
            RaggedTimeseriesProfile,
            jn(dn(__file__), "timeseriesProfile", "resources", "r-multiple.nc"),
        ),
    ],
)
